...
from nisystemlink.clients.product.models import (Product, ProductField,
...
class ProductClient:
    ...
    def __initialize_product_client(self):
        if(self.__api_key and self.__systemlink_uri):
            server_configuration = HttpConfiguration(
                server_uri = self.__systemlink_uri,
    ...
    def query_products(self, products_filter: str) -> List[Product]:
        ...
        """
        products_query = QueryProductsRequest(filter = products_filter, order_by=ProductField.UPDATED_AT, take=HttpConstants.TAKE)
